package io.kestra.plugin.opensearch-lib;
    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.opensearch-lib.OpensearchLibTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class OpensearchLibTask extends Task implements RunnableTask<OpensearchLibTask.Output> {
    @Schema(
    ...
    @Override
    public OpensearchLibTask.Output run(RunContext runContext) throws Exception {
